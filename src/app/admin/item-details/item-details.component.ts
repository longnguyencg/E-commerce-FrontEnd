...
export class ItemDetailsComponent implements OnInit {
        ...
        (params: Params) => {
          ...
          this.itemServ.cast.subscribe(datas => {
            ...
            this.editForm = this.fb.group({
              ...
              sale_price: [this.inItems.sale_price, [Validators.required]],
              description: [this.inItems.description, [Validators.required, Validators.minLength(4)]]
            });
          });
        }
      );
  ...
  get sale_price() {
    return this.editForm.get('sale_price');
  }
  get description() {
